          ...
          <div className="mb-4 flex items-end justify-between gap-4 px-1">
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-slate-500">
                POI Trader OS · Advanced Chart
              </p>
              <h2 className="mt-1 text-xl font-semibold tracking-tight md:text-2xl">
                XAU/USD Market Chart
              </h2>
            </div>
            <span className="hidden rounded-full border border-white/10 bg-white/[0.03] px-3 py-1 text-[10px] text-slate-400 md:inline-flex">
              Lightweight Charts · Real-time ready · 10k candle cap
            </span>
          </div>
          <FinancialChart symbol="XAU/USD" initialTimeframe="15m" height={760} />
        </div>
      </section>
    </>
  );
