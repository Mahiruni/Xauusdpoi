          ...
          <div className="mx-auto max-w-[1260px]">
            <div className="mb-5 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
              <div>
                ...
                <h2 className="mt-1 text-[24px] font-semibold tracking-[-0.045em]">XAU/USD market chart</h2>
                <p className="mt-1 text-[10px] text-[#777b83]">Live pricing is intentionally disabled until a new market-data source is connected.</p>
              </div>
              <span className="inline-flex w-fit rounded-full border border-black/[0.07] bg-white/75 px-3 py-2 text-[8px] font-bold tracking-[0.08em] text-[#7f838a]">NO EXTERNAL DATA PROVIDER</span>
            </div>
